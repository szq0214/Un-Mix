...
def main():
    ...
    if args.data_path == 'cifar10':
        train_dataset = datasets.CIFAR10(root='data/CIFAR-10', download=True, train=True)
        val_dataset = datasets.CIFAR10(root='data/CIFAR-10', download=True, train=False)
    elif args.data_path == 'cifar100':
        train_dataset = datasets.CIFAR100(root='data/CIFAR-100', download=True, train=True)
        val_dataset = datasets.CIFAR100(root='data/CIFAR-100', download=True, train=False)
    ...
    linear_classifier = RegLog(args.num_labels, args.arch, args.global_pooling, args.use_bn)
